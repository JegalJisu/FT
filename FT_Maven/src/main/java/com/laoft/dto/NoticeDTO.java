...
public class NoticeDTO {
	...
	private String cnt; // �Խñ� ��
	
	private String user_no;

	private String start_page; // �Խñ� ������ ���� ���ڵ�
	private String end_page; // �Խñ� ������ ������ ���ڵ�
	
	private List<NoticeComDTO> rList; // ��ȸ ��� ��������
    private List<NoticeDTO> eList; // ��ȸ ��� ��������
	...
	private String[] allCheckSeq; // ������ �׸� �迭�� �ޱ�
